...
princp=[]
try:
    prox= requests.get('https://github.com/HAKER-K1NG/Paid/blob/main/Aprove.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/HAKER-K1NG/Paid/blob/main/Aprove.txt').text
        ua=open('bbnew.txt','w')
